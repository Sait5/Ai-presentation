...
Демонстрационная версия: [forma-documents.vercel.app](https://forma-documents.vercel.app). Клиент и API размещены на Vercel, отдельная PostgreSQL-база — Neon Free. Локальные аккаунты и документы автоматически в облако не переносятся.
